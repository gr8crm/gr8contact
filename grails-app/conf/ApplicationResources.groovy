modules = {
    ...
    'gr8conf-eu-crm' {
        ...
        resource url: [id: 'crm-ui-bootstrap-less', dir: 'less-dk', file: 'crm-ui-bootstrap.less'], attrs: [rel: "stylesheet/less", type: 'css', order: 110], disposition: 'head'
    ...
    'gr8conf-eu' {
        dependsOn 'gr8conf-eu-crm'
        resource id:'bootstrap-less', url:[dir: 'less-dk', file: 'bootstrap.less'], attrs:[rel: "stylesheet/less", type:'css', order:100], disposition: 'head'
        resource id:'bootstrap-responsive-less', url:[dir: 'less-dk', file: 'responsive.less'], attrs:[rel: "stylesheet/less", type:'css', order:150], disposition: 'head'
        resource url:[dir: 'less-dk', file: 'gr8conf-eu.less'], attrs:[rel: "stylesheet/less", type:'css', order:10], disposition: 'head'
        resource url:'js/application.js'
    }
    'gr8conf-us-crm' {
        dependsOn 'jquery, modernizr, bootstrap-js'
